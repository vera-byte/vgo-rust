    ...
    fn add_to_builder(
        ...
        match self {
            ...
            ConfigSource::Memory(map) => {
                // 将 HashMap 转换为 JSON 字符串，然后作为字符串源加载
...
mod tests {
    ...
    fn test_config_from_string() {
        ...
        let source = ConfigSource::String { content: toml_content, format: FileFormat::Toml };
    ...
    fn test_config_from_memory() {
        ...
        map.insert("server.host".to_string(), serde_json::Value::String("127.0.0.1".to_string()));
